...
const Gallery = () => {
  return (
    <section id="gallery" className="flex flex-col items-center justify-center bg-white py-12 min-h-dvh">
      <div className="max-w-5xl text-center">
        ...
        <div className="flex flex-row justify-center items-center gap-8">
          <div className="w-full h-auto rounded-2xl shadow-xl/50 overflow-hidden timeline-view
           animate-fade-in-right animate-range-[entry_10%_contain_60%] transition-all duration-300 hover:scale-105">
          ...
          <div className="w-full h-auto rounded-2xl shadow-xl/50 overflow-hidden timeline-view
           animate-fade-in-up animate-range-[entry_10%_contain_60%] transition-all duration-300 hover:scale-105">
          ...
          <div className="w-full h-auto rounded-2xl shadow-xl/50 overflow-hidden timeline-view
           animate-fade-in-left animate-range-[entry_10%_contain_60%] transition-all duration-300 hover:scale-105">
